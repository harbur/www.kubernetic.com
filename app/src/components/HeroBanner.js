      ...
      <div className="welcome-content">
        ...
        <div className="welcome-buttons">
          <OutboundLink
            ...
            to="https://kubernetic.s3.amazonaws.com/Kubernetic-2.9.0.dmg"
          >
            Download Now
          </OutboundLink>
          <p>
            <small>
              <i>
                ...
                <ReactGA.OutboundLink
                  ...
                  to="https://kubernetic.s3.amazonaws.com/Kubernetic-2.9.0.tar.gz"
                >
                  {" "}
                  Linux
                </ReactGA.OutboundLink>{" "}
                ...
                <ReactGA.OutboundLink
                  ...
                  to="https://kubernetic.s3.amazonaws.com/Kubernetic+Setup+2.9.0.exe"
                >
                  {" "}
                  Windows
                </ReactGA.OutboundLink>
